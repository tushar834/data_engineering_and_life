...
public class SparkSession {
	...
	public static void main(String[] args) throws AnalysisException {
		...
		Dataset<Row> logData = spark.read().option("header","true").csv("C:\\Users\\lenovo\\Downloads\\new.csv");
		
		
		Dataset<Row> logData1 = spark.read().option("header","true").csv("C:\\Users\\lenovo\\Downloads\\new2.csv");
